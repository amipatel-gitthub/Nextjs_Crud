...
export default function Page() {
  ...
  const createRecord = (data) => {
    ...
    localStorage.setItem("User_Table", JSON.stringify([...records, newRecord]));
  };
  ...
  const updateRecord = (data) => {
    ...
    setRecords(up_data);
    localStorage.setItem("User_Table", JSON.stringify(up_data));
  };
  ...
  useEffect(() => {
    const storeData = JSON.parse(localStorage.getItem("User_Table")) || [];
    setOriginalRecords(storeData);
    ...
    <>
      <div className="container mx-auto mt-10 p-2 sm:mt-10">
        <div className="mx-auto sm:w-4/5 lg:w-4/12 bg-white my-3 shadow-md rounded-lg p-3">
          ...
          >
            <input
              className="border-purple-700 mb-2 sm:mb-0 sm:mr-2 pl-3 leading-tight block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-purple-500 focus:outline-none focus:ring-0 focus:border-purple-600 peer"
              type="text"
              placeholder="Name"
