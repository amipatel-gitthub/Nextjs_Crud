...
export default function page() {
    ...
    const handleSubmit = (e) => {
        ...
        localStorage.setItem("form_Value", JSON.stringify(records));
    ...
    const createRecord = (data) => {
        ...
        localStorage.setItem("form_Value", JSON.stringify([...records, newRecord]));
    };
    ...
    const updateRecord = (data) => {
        ...
        setRecords(up_data);
        localStorage.setItem("form_Value", JSON.stringify(up_data));
    };
    ...
    useEffect(() => {
        const storeData = localStorage.getItem("form_Value");
        if (storeData) {
            setRecords(JSON.parse(storeData));
        }
    }, []);
