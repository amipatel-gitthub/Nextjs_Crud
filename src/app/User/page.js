...
export default function Page() {
    ...
    const handleDropDown = () => {
        return (
            <select value={itemPerPage} onChange={handlePageRender} className="py-1.5  border">
    ...
    return (
        <div className="container mx-auto mt-36 p-4">
            <div className="mx-auto  lg:w-4/12 bg-white my-5 shadow-md rounded-lg p-4" >
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row items-center py-2">
                    <input
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead className="bg-gray-200 dark:bg-gray-700 ">
                                        <tr className="hover:bg-gray-50">
                                            <th className="px-4 py-2 border font-semibold text-gray-700 bg-gray-200">Name</th>
                                            <th className="px-4 py-2 border font-semibold text-gray-700 bg-gray-200">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                        {displayedItem.map((value) => (
                                            <tr key={value.id} className="hover:bg-gray-50 text-center">
